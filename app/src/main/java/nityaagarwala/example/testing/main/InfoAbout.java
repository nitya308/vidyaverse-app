...
//Class to display About information
public class InfoAbout extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Toolbar myToolbar = (Toolbar) findViewById(R.id.toolbar_6);
